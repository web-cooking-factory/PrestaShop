...
const baseContext: string = 'functional_BO_catalog_monitoring_sortPaginationAndBulkDelete_productsWithoutDescription';
...
describe('BO - Catalog - Monitoring : Sort and pagination list of products without description', async () => {
  ...
  const tableName: string = 'product_without_description';
